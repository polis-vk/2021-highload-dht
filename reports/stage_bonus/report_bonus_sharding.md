...
По полученным результатам и всему вышесказанному я бы назвал _Maglev_ вместе с _Fnv1_ является 
оптимальным решением для распределения узлов.
Данное решение является быстрым для получения узлов по ключу и имеет очень хорошую равномерность распределения.
...
_Maglev_ не является лучшим во всем, а лишь хорошо балансирует между скоростью и равномерностью распределения.