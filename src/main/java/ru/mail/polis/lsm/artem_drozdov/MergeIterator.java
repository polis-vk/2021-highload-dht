...
public class MergeIterator implements Iterator<Record> {
    ...
    private final LsmDAO.PeekingIterator left;
    private final LsmDAO.PeekingIterator right;

    public MergeIterator(LsmDAO.PeekingIterator left, LsmDAO.PeekingIterator right) {
        this.left = left;
        this.right = right;
    }
