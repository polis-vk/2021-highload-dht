...
Видно из таблиц, что при маленьком размере очереди, происходят таймауты(для 10 и 100, так что, скорее всего они не показ
ательны). В основном же практически никаких отличий нет.
