...
|         | Lab 2   |  Lab 3 (queue size = 100)   |
|:-------:|:-------:|:------:|
| 50.000% | 0.86ms | 0.93ms |
| 75.000% | 1.16ms |1.25ms |
| 90.000% | 1.38ms | 1.51ms |
| 99.000% | 1.72ms | 2.07ms |
| 99.900% | 3.83ms | 4.00ms |
| 99.990% | 7.05ms | 6.30ms |
| 99.999% | 23.36ms | 9.00ms |
| 100.000% | 30.86ms | 38.27ms |

**Вывод**: добавление executor'a позволило уменьшить значение процентиля "99,999%" с ~23.36ms до ~9.0ms.
...
|:-------:|:-------:|:------:|
| 50.000% | 1.0ms | 1.03ms | 
| 75.000% | 1.36ms | 1.39ms |
| 90.000% | 1.62ms | 1.65ms |
| 99.000% | 2.01ms | 2.13ms |
| 99.900% | 2.48ms | 2.68ms |
| 99.990% | 3.82ms | 5.01ms |
| 99.999% | 6.79ms | 7.65ms |
| 100.000% | 10.07ms | 9.53ms |

**Вывод**: добавление executor'a не изменило время ответа на get-запросы.
